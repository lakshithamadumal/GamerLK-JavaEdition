window.onload = async function () {
    ...
    if (response.ok) {
        ...
        // Assuming 'json' contains the user profile data
        document.getElementById("SettingsFirstName").value = json.firstName;
        document.getElementById("SettingsLastName").value = json.lastName;
