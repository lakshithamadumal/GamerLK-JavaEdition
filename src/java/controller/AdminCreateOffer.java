...
public class AdminCreateOffer extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (gameId == null || gameId.trim().isEmpty()) {
            ...
            Transaction tx = null;
            try {
                // 1. Product එක තියෙනවද බලන්න (Criteria)
                ...
                if (product == null) {
                    ...
                    // 2. Status එක Active/Inactive ද බලන්න
                    ...
                    if (!("Active".equalsIgnoreCase(statusValue) || "Inactive".equalsIgnoreCase(statusValue))) {
                        ...
                        // 3. Status Offer වලට මාරුකරලා, offer % එක set කරන්න
                        tx = s.beginTransaction();
                        // Offer status (assume id=3, value="Offer")
