 ...
 * @author Laky
 */
@WebServlet(name = "LoadOfferGmames", urlPatterns = {"/LoadOfferGmames"})
public class LoadOfferGmames extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            criteriaProduct.add(org.hibernate.criterion.Restrictions.eq("status.value", "Offer"));
